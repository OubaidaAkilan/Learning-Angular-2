import { AngularLinkOptions, StrapiEnvironment, versionDate } from "src/environments/environment.common";

const environmentLettiral = StrapiEnvironment.Production;
